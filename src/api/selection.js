...
// 获取答题用户信息
export function getAnswerUserInfo(params = {}) {
  params.op = "Selection.getAnswerUserInfo";
  return request({
    url: "/index.php",
    method: "get",
    params,
...
// 获取题目
export function getAnswerQuestion(params = {}) {
  params.op = "Selection.getAnswerQuestion";
  return request({
    url: "/index.php",
    method: "get",
    params,
