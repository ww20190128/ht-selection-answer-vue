    ...
    <div class="content-wrap">
      ...
      >
        <van-swipe-item
          ...
          :key="index"
        >
          <div class="question-preview question-wrap" :class="{ split: 1 }">
            <!--有材料-复合体-->
            <template
              v-if="
                item?.materialList?.length > 0 &&
                item?.typeInfo?.name == '主观题'
              "
            >
              <div class="split-box split-top">
                <!-- <div class="tag" v-if="item?.isSL">
                  {{ "申论-主观题" }}
                </div>
                <div
                  class="tag"
                  v-else-if="
                    item?.typeInfo && item?.typeInfo?.name && item?.isSL
                  "
                >
                ...
                <div
                  class="tag knowledge"
                  v-if="item?.knowledgeInfo && item?.knowledgeInfo?.name"
                >
                ...
                >
                  <van-tab
                    ...
                    :title="material.name || `材料${index + 1}`"
                  >
                    <div
                      class="material"
              ...
              <div class="split-box split-bottom">
                ...
                >
                  <van-tab
                    v-for="(matterItem, index) in item.matterList"
                    :key="matterItem.id || index"
                    :title="`问题${index + 1}`"
                  >
                    <div class="matter-wrap bd">
                      <div
                        class="matter"
                      ...
                      <div
                        ...
                        v-html="decodeTag(matterItem.matter, item.imgUrlBase)"
                      ></div>
                      <div class="title-tag"><span>思维导图</span></div>
                      <div
                        class="matter"
                        v-html="decodeTag(matterItem.matter, item.imgUrlBase)"
                      ></div>
            ...
            <template v-else>
              ...
              <div class="tag" v-if="item?.materialList">
                {{ item?.materialList.length }}个材料
              </div>
              <van-tabs
                v-if="item?.materialList?.length > 0"
                v-model:active="activeTab"
